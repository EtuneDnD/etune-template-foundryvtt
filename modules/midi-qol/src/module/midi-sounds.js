	...
	static getSubtype(item) {
		...
		switch (item.type) {
			...
			case "equipment":
				...
				break;
			case "consumable":
				subtype = "consumable." + item.data.data.consumableType;
				break;
			case "spell":
				subtype = "spell." + item.data.data.school;
				break;
			case "tool":
				subtype = "tool." + item.data.data.toolType;
				break;
			case "equipment":
				subtype = "equipment." + item.data.data.equipmentType;
				break;
