...
*/
export function createDamageList({ roll, item, versatile, defaultType = MQdefaultDamageType }) {
	let damageParts = {};
...
*
*/
export function getTraitMult(actor, dmgTypeString, item) {
...
export async function doOverTimeEffect(actor, effect, startTurn = true) {
	...
	if (effect.data.disabled || effect.isSuppressed)
		return;
