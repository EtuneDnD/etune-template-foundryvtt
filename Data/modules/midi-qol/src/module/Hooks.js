...
import { untargetDeadTokens, untargetAllTokens, midiCustomEffect, getConcentrationEffect, removeReactionUsed, removeBonusActionUsed, checkflanking, getSystemCONFIG, expireRollEffect, doConcentrationCheck } from "./utils.js";
...
export let readyHooks = async () => {
	...
	Hooks.on("deleteActiveEffect", (...args) => {
		...
		let changeFunc = async () => {
			...
			if (installedModules.get("times-up") && effect.duration.remaining <= 0)
				return;
			try {
