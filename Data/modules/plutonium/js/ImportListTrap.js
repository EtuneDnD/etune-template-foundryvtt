...
class ImportListTrap extends ImportListActor {
	...
	_pImportEntry_fillData_Currency (trap, sys) {
		sys.currency = {pp: 0, gp: 0, ep: 0, sp: 0, cp: 0}; // Dummy data
	}

	_pImportEntry_fillData_Skills (trap, sys) { /* No-op */ }

	_pImportEntry_fillData_Spells (trap, sys) { /* No-op */ }

	_pImportEntry_fillData_Bonuses (trap, sys) { /* No-op */ }

	_pImportEntry_fillData_Resources (trap, sys) { /* No-op */ }
