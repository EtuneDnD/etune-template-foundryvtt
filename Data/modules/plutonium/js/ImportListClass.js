...
class ImportListClass extends ImportListCharacter {
	...
	_getBlacklistFilteredData ({dedupedAllContentMerged}) {
		return ImportListClass.Utils.getBlacklistFilteredData({dedupedAllContentMerged});
	}
...
ImportListClass.Utils = class {
	...
	static getBlacklistFilteredData ({dedupedAllContentMerged}) {
