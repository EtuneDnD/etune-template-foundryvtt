...
import {DataConverterAdventure} from "./DataConverterAdventure.js";
...
class ImportListAdventure extends ImportListAdventureBook {
	...
	_pGetJournalDatas () {
		return DataConverterAdventure.pGetAdventureJournals(this._content.data, this._content._contentMetadata, {isAddOwnership: true});
	}
}
