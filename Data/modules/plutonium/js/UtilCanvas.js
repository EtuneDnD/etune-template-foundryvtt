class UtilCanvas {
	/**
	 * @param evt
	 * @param layerName One of: "WeatherEffects", "GridLayer", "DrawingsLayer", "TemplateLayer", "TilesLayer",
	 * "WallsLayer", "TokenLayer", "SoundsLayer", "LightingLayer", "NotesLayer", "ControlsLayer"
	 * @return {{x: *, y: *}}
	 */
